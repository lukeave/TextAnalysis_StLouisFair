...
if (!file.exists("word_embbedings/fullcorpus_bngrams.bin")) {model = train_word2vec("word_embbedings/fullcorpus_bngrams.txt","word_embbedings/fullcorpus_bngrams.bin",vectors=50,threads=4,window=30,iter=30,negative_samples=0)} else model = read.vectors("word_embbedings/fullcorpus_bngrams.bin")
